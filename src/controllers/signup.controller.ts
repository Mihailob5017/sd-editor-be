...
import { SignupResponseInterface, SignupUserInterface } from 'helpers/types';
...
export const SignUpController = async (
	...
	try {
		...
		if (inputData) {
			...
			const newUser: SignupUserInterface = await prismaClient.user_table.create(
				{
					data: {
						key_id: keyID,
						...
						rank: currentRank,
						solved_issues_count: solvedIssuesCount,
					},
				}
			);
